...
date			by			bug fixed
27/08/2007		Suusi M-B	conditional assembly bug in == and != 
	...
	for (;;)
	{
		...
		if (expr.inf!=Expr::EX_UNDEF && expr2.inf!=Expr::EX_UNDEF)	// obliczyæ wartoœæ?
			if (expr.inf==Expr::EX_STRING && expr2.inf==Expr::EX_STRING)
			{
				...
				case O_EQ:
//					expr.value = expr.string != expr2.string;
					expr.value = expr.string == expr2.string;		// Bug Fix Suusi M-B 27 August 2007
					break;
				case O_NE:
//					expr.value = expr.string == expr2.string;
					expr.value = expr.string != expr2.string;		// Bug Fix Suusi M-B 27 August 2007
			...
			else
			{
				...
				case O_EQ:
//					expr.value = expr.value != expr2.value;
					expr.value = expr.value == expr2.value;			// Bug Fix Suusi M-B 27 August 2007
					break;
				case O_NE:
//					expr.value = expr.value == expr2.value;
					expr.value = expr.value != expr2.value;			// Bug Fix Suusi M-B 27 August 2007
